    ...
    <header className="w-full bg-[#080A0F]/95 backdrop-blur-xl border-b border-white/10 shadow-lg">
      ...
      <div className="bg-[#0c0f0f] border-b border-white/5 text-xs text-slate-300 py-1.5 px-3 sm:px-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 sm:gap-3 text-xs">
            <span className="text-national-red font-bold text-xs">ВОА РФ</span>
            ...
            <span className="text-slate-400 text-xs hidden md:flex items-center gap-1">
              <ShieldCheck className="w-3.5 h-3.5 text-slate-500 keep-icon" /> Лицензия № 07894 • Закрытый автодром
            </span>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded border text-xs font-bold transition min-h-[36px] ${
                isActive
      ...
      <div className="max-w-7xl mx-auto px-4 py-2.5 sm:py-3 flex items-center justify-between relative">
        ...
        <div className="hidden lg:flex items-center gap-7 text-xs uppercase tracking-wider font-bold text-slate-300 flex-1 justify-end pr-10">
          ...
          <a href="#pricing" className="nav-glow transition-colors py-2">Цены</a>
          <a href="#autodrome" className="nav-glow transition-colors py-2">Автодром</a>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-6 text-xs uppercase tracking-wider font-bold text-slate-300 flex-1 justify-start pl-10">
          ...
          <a href="#reviews" className="nav-glow transition-colors py-2">Отзывы</a>
          ...
          <div className="flex items-center gap-4 ml-auto">
            ...
            <button
              ...
              className="min-h-[44px] bg-national-red text-white px-5 py-2.5 rounded-sm font-extrabold uppercase tracking-wider text-xs hover:bg-red-700 transition-all hover:shadow-[0_0_20px_rgba(227,30,36,0.5)] transform hover:-translate-y-0.5 duration-200 flex items-center justify-center"
            >
              Записаться
            </button>
          </div>
        ...
        <div className="flex items-center gap-2 lg:hidden">
          ...
          <button
            ...
            className="p-2.5 rounded bg-surface-card border border-white/10 text-white min-w-[44px] min-h-[44px] flex items-center justify-center"
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-[#0c0f0f] border-b border-white/10 px-4 py-6 space-y-4 animate-fadeIn">
          <nav className="flex flex-col gap-2 text-sm font-bold uppercase tracking-wider">
            ...
            <a href="#pricing" onClick={() => setMobileMenuOpen(false)} className="px-3 py-3 rounded hover:bg-white/5 hover:text-national-red">Цены</a>
            <a href="#autodrome" onClick={() => setMobileMenuOpen(false)} className="px-3 py-3 rounded hover:bg-white/5 hover:text-national-red">Автодром</a>
            ...
            <a href="#reviews" onClick={() => setMobileMenuOpen(false)} className="px-3 py-3 rounded hover:bg-white/5 hover:text-national-red">Отзывы</a>
