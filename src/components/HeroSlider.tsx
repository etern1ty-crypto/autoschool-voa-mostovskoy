...
const slides: Slide[] = [
  ...
  {
    id: 1,
    badge: 'Собственный учебный автодром 2 ГА',
    badgeIcon: MapPin,
    title: 'Просторный автодром',
    highlight: 'без очередей и помех',
    description: 'Отрабатывайте все экзаменационные упражнения на нашей закрытой асфальтированной площадке 2 га по ул. Кирова 1Д: эстакада с уклоном, параллельная парковка, заезд в бокс под 90° и змейка. Вы будете чувствовать габариты машины на 100% уверенно.',
    image: '/images/slider/autodrome.jpg',
    imageAlt: 'Учебный автодром автошколы ВОА',
    features: [
      'Собственная площадка 2 га (ул. Кирова, 1Д)',
