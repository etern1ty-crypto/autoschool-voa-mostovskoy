...
const slides: Slide[] = [
  {
    ...
    description: 'Наш автопарк укомплектован новыми автомобилями Lada Granta, Datsun on-DO, Lada Kalina и грузовым ГАЗ-3309. Все машины оборудованы сертифицированными дублирующими педалями, кондиционерами и системами видеофиксации для экзамена ГИБДД.',
  ...
  },
  {
    ...
    description: 'Отрабатывайте все экзаменационные упражнения на нашей закрытой асфальтированной площадке: эстакада с уклоном, параллельная парковка, заезд в бокс под 90° и змейка. Вы будете чувствовать габариты машины на 100% уверенно.',
    ...
    features: [
      ...
      'Комфортная зона ожидания и инструктажа',
    ],
