...
export const AutodromeSection: React.FC<AutodromeSectionProps> = ({ onOpenBooking }) => {
  ...
  return (
    <section id="autodrome" className="py-20 bg-[#080A0F] relative border-b border-white/5">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          {/* Autodrome Image: 100% clean without badge overlays */}
          ...
          <div className="lg:col-span-6 space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              {exercises.map((ex, idx) => (
                <div key={idx} className="dashboard-card p-3.5 rounded-lg border-white/10">
            ...
            <div className="pt-2">
              <button
                ...
                className="bg-national-red text-white px-6 py-3.5 rounded-sm font-extrabold uppercase tracking-wider text-xs hover:bg-red-700 transition flex items-center gap-2 shadow-lg shadow-national-red/30"
              >
