...
export const AccessibilityBar: React.FC = () => {
  ...
  return (
    <div className="bg-slate-900 border-b border-amber-500/30 text-white px-4 py-3 shadow-lg z-50 sticky top-0 transition-all">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex gap-1.5">
            <button
              ...
              className={`w-7 h-7 rounded border-2 transition-all flex items-center justify-center font-bold text-xs bg-slate-950 text-white ${
            ...
            <button
              ...
              className={`w-7 h-7 rounded border-2 transition-all flex items-center justify-center font-bold text-xs bg-white text-black ${
            ...
            <button
              ...
              className={`w-7 h-7 rounded border-2 transition-all flex items-center justify-center font-bold text-xs bg-black text-white ${
            ...
            <button
              ...
              className={`w-7 h-7 rounded border-2 transition-all flex items-center justify-center font-bold text-xs bg-[#99d6f3] text-[#063462] ${
