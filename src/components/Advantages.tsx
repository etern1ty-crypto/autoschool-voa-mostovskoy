...
export const Advantages: React.FC = () => {
  const items = [
    {
      icon: MapPin,
      title: 'Собственный автодром',
      desc: 'Закрытая асфальтированная площадка с эстакадой и полной разметкой ГИБДД. Никаких очередей и посторонних машин.',
    ...
    {
      icon: DollarSign,
      title: 'Все включено в цену',
      desc: 'Стоимость обучения фиксируется в договоре. Бензин (ГСМ), автодром и подготовка документов уже включены.',
      color: 'text-blue-400',
    ...
    },
    {
      ...
      desc: 'Теория очно в вечерних группах или онлайн. Практические занятия на автодроме и в городе с 07:00 до 21:00.',
      color: 'text-cyan-400',
