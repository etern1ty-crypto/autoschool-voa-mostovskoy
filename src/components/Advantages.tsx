...
export const Advantages: React.FC = () => {
  const items = [
    {
      icon: MapPin,
      title: 'Собственный автодром 2 ГА',
      desc: 'Закрытая асфальтированная площадка 2 га (ул. Кирова, 1Д) с эстакадой и разметкой ГИБДД. Без очередей и посторонних машин.',
